...
// ===== Rutas =====
import newsRouter from "./routes/news.routes.js";      // 👈 corregido
...
// Carpeta donde está tu frontend (index.html, CSS, imágenes…)
const docsDir = path.resolve(__dirname, "docs");

// ===== Middlewares globales =====
app.set("trust proxy", 1); // Render, etc.
app.use(helmet());
...
const corsOptions = {
  origin: (origin, cb) => cb(null, true), // por ahora permite todos
  credentials: true,
};
...
// ===== STATIC FRONTEND =====
// Sirve todo lo que haya dentro de /docs (index.html, css, js, imagenes…)
app.use(express.static(docsDir));
// opcional: también accesible bajo /docs
app.use("/docs", express.static(docsDir));

// Static para descargas públicas
...
const FALLBACK_QUESTIONS = [
  ...
  },
  {
    ...
    correct: "B",
    explanation:
      "Asegura condiciones mínimas de calidad y seguridad.",
  },
  {
    id: "col-5",
    ...
    correct: "B",
    explanation:
      "Regula y controla medicamentos, alimentos y dispositivos.",
  },
];
...
// ===== Rutas de frontend =====
// Cuando alguien entra a "/", devolvemos tu index.html de /docs
app.get("/", (_req, res) => {
...
// ===== Arranque =====
app.listen(PORT, () => {
  console.log(`API + Front listo en http://localhost:${PORT}`);
});
